...
<tr id="amon"><td> amon faria </td><td> amon faria </td><td> amon.faria@gmail.com </td><td><button type="button"  rel="tooltip" data-toggle="modal" data-target="verify-delete-modal" title="Negar Acesso" class="button-small-red-inverse pure-button red-tooltip"> <i class="fa fa-times fa-lg"></i></button> </td><td><button type="button" data-toggle="modal" data-toggle="tooltip" title="Aprovar Acesso" class="button-small-green-inverse pure-button green-tooltip"> <i class="fa fa-check fa-lg"></i> </button> </td></tr><tr id='36'><td> isaque </td><td> isaque </td><td> ifaria@gmail.com </td><td><button onclick="hide(36)" type="button" rel="tooltip" title="Negar Acesso" class="button-small-red-inverse pure-button red-tooltip"> <i class="fa fa-times fa-lg"></i></button> </td><td><button type="button" rel="tooltip" title="Aprovar Acesso" class="button-small-green-inverse pure-button green-tooltip"> <i class="fa fa-check fa-lg"></i> </button> </td></tr>
