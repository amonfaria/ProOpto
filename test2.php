...
$(document).ready(function() {
	$('a[data-confirm]').click(function(ev) {
		...
		if (!$('#dataConfirmModal').length) {
			$('body').append('<div id="dataConfirmModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="dataConfirmLabel" aria-hidden="true"><div class="modal-dialog modal-sm"><div class="modal-content">Certeza que quer excluir?<button class="pure-button-red pure-button pure-button-primary" data-dismiss="modal" aria-hidden="true">Cancelar</button><a class="pure-button-green pure-button pure-button-primary" id="dataConfirmOK">Confirmar</a></div></div>');
		} 
