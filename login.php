...
<div class="width300 pure-control-group">
...
<div class="with300 pure-control-group">
    <input type='password' name='password' id='password' maxlength="50" placeholder="Senha" required>
    <span id='login_password_errorloc' class='error'></span>
</div>

    <input class="pure-button pure-button-primary"  type='submit' name='Submit' value='Entrar' />
